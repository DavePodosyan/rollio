                ...
                >
                    ...
                    <View style={{ backgroundColor: '#FFFFFF0D', borderRadius: 32, padding: 16, flexDirection: 'row' }}>
                        <View>
                            ...
                            >
                                <Text style={{ color: '#FFFFFF', fontFamily: 'Lufga-Medium', fontSize: 18, lineHeight: 26 }}>{item.id}</Text>
                            </View >
                        </View>
                        <View style={{ marginLeft: 16, minHeight: 52, flex: 1 }}>
                            ...
                            <View style={{
                                ...
                                <View style={{
                                    ...
                                    <Text style={{ color: '#FFFFFF', fontFamily: 'Lufga-Regular', fontSize: 16, lineHeight: 24, marginLeft: 8 }}>{item.shutter}</Text>
                                </View >
