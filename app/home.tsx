...
export default function Home() {
    ...
    return (
        <><View style={{ flex: 1, paddingTop: insets.top, paddingBottom: 0 }}>
            ...
            {/* <ScrollView contentContainerStyle={{ paddingTop: 10, paddingBottom: 50, paddingLeft: 12, paddingRight: 12 }} >
                <RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#FFFFFF99" />
                <FilmCard />
                <FilmCard />
                <FilmCard />
                <FilmCard />
